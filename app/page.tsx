      ...
      <nav className={`fixed top-0 w-full z-50 transition-colors duration-200 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold tracking-tight">Bracketly</span>
          </Link>

          <div className="hidden md:flex items-center gap-8 text-[13px] font-semibold text-slate-500 uppercase tracking-wider">
            <Link href="/tournaments" className="hover:text-slate-900 transition-colors">Tournaments</Link>
            <Link href="#features" className="hover:text-slate-900 transition-colors">Infrastructure</Link>
            <Link href="/admin/login" className="bg-[#4169E1] text-white px-5 py-2 rounded shadow-sm hover:bg-blue-700 transition-colors flex items-center gap-2">
